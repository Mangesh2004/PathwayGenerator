  ...
  return (
    ...
    >
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        ...
        <span className="group-hover/feature:translate-x-2 transition duration-200 text-xl inline-block text-slate-300 dark:text-neutral-100">
          {title}
        </span>
      </div>
      <div className="text-lg text-slate-200 dark:text-neutral-300 max-w-xs relative z-10 px-10 ">
        {description}
      </div>
    </div>
  );
